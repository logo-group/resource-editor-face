...
public class ResourceItemDataProvider<T extends ReLanguageTable> extends AbstractDataProvider<ReResourceitem> {
	...
	@Autowired
	public ResourceItemDataProvider(BeanFactory beanFactory, TurkishtrService turkishService, AlbaniankvService albanianService, ArabicegService arabicEgService,
