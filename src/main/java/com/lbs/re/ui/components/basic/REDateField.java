 ...
 */
public class REDateField extends DateField implements ResourceEditorLocalizerWrapper {

    private static final long serialVersionUID = 1L;

    public REDateField(String id, String style, boolean isSizeFull, boolean isEnabled) {
        super();
        setStyleName(style);
        if (isSizeFull) {
            setSizeFull();
