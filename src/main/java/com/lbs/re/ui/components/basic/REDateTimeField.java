 ...
 */
public class REDateTimeField extends DateTimeField implements ResourceEditorLocalizerWrapper {

    private static final long serialVersionUID = 1L;

    public REDateTimeField(String id, String style, boolean isSizeFull, boolean isEnabled) {
        super();
        if (isSizeFull) {
            setSizeFull();
        }
