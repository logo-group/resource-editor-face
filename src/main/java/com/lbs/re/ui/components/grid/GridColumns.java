...
public class GridColumns {
	...
	public static enum GridColumn {
		...
		public static final List<GridColumn> ADVANCED_SEARCH_GRIDS = Arrays.asList(SEARCHED_ORDER_NUMBER, SEARCHED_TAG_NUMBER, ITEM_TURKISH, ITEM_ENGLISH, ITEM_STANDARD,
